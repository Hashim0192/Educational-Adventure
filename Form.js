...
if(correctans === "Yes"){
this.greetingq1.html("Awesome, correct,Now if you want a harder question,refresh your page and press level 2" )
this.greetingq1.position(700,300)
}
...
this.check2.mousePressed(()=>{
    ...
    var answer = this.l2input.value()
    var correctans = (answer == 192) ? "Yes" : "No";
   console.log(correctans);
   
   
   if(correctans === "Yes"){
   this.greetingq1.html("Awesome, correct,Now if you want a harder question,refresh your page and press level 3" )
   this.greetingq1.position(700,300)
   }
...
this.check3.mousePressed(()=>{
   ...
   if(correctans === "Yes"){
   this.greetingq1.html("Awesome! correct, You have officialy completed all of the questions. Well Done!" )
   this.greetingq1.position(700,300)
   }
